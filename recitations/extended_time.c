...
void subtractDate(Date* op1, Date* op2, Date* op3,int borrow){
	...
	op3->month = op1->month - op2->month + borrow - 1;
	op3->month += 12;
...
void addExtendedTime(ExtendedTime* op1, ExtendedTime* op2, ExtendedTime* op3){
	...
	addDate(op1->date, op2->date, op3->date);
}
...
void subtractExtendedTime(ExtendedTime* op1, ExtendedTime* op2, ExtendedTime* op3){
	...
	subtractDate(op1->date, op2->date, op3->date);
}
...
int main()
{
	...
	a->time = (Time*) malloc(sizeof(ExtendedTime));
	...
	b->time = (Time*) malloc(sizeof(ExtendedTime));
	...
	c->time = (Time*) malloc(sizeof(ExtendedTime));
	c->date = (Date*) malloc(sizeof(Date));
	
	ExtendedTime* d;
	d = (ExtendedTime*) malloc(sizeof(ExtendedTime));
	d->time = (Time*) malloc(sizeof(ExtendedTime));
